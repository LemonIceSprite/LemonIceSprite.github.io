...
var repoIssuesUrl = "https://api.github.com/repos/lemonicesprite/blog_comment/issues";
// 对应仓库 clientId、clientSecret 关于这两个参数的安全问题，查看 https://removeif.github.io/2019/09/19/博客源码分享.html#1-热门推荐，最新评论：
var clientId = "cd0beaae16e9a0113bc4";
var clientSecret = "8210d021e688a91ace0b86ec00a23b6292e0b872";
...
function loadIssueData() {
    setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        console.clear();
        console.log("~~~~欢迎光临！记得有时间多来看看哦，https://lemonicesprite.github.io/ ~~~~")
    }
        ,
        500
    )
